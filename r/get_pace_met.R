...
###################################################################################
 ...
 # read ros met
ym.met.df <- readRDS('d:/repo/PhenoMods/cache/smsmv13.2q.chain.ym.Control.Ambient.rds')
ym.ros <- readRDS('data/ros05.rds')
# 
...
# ym.met.df$site <- 'ym'
# paddock.met.df <- readRDS('d:/repo/PhenoMods/cache/smsmv13.2q.chain.flux.Control.Ambient.rds')
# paddock.met.df$site <- 'paddock'
# 
# flux.met.df <- rbind(ym.met.df,paddock.met.df)
# read pace rainfall
# make time of day
