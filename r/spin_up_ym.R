...
source('r/creat_cfg_climGrassRun.R')
# 
spinup.ym.func <- function(folder.nm = 'model/ym_spinup/',met.nm = 'model/ym_spinup//met.csv',sin.yr = 100){
  # 
...
spin.df <- spin.up.func(folder.nm = 'model/ym_spinup/',
                        source.nm = 'model/CG_C0T0D0/',sin.yr = 400)
